<?php
//là nơi để kết nối với cơ sở dữ liệu
...
class ConnectDB{
    ...
    public $sql;
    public $sta;
    //khai bao phuong thuc khoi tao de lam phuong thuc ket noi csdl
    public function __construct(){
        try{
            $this->pdo = new PDO ( 
                'mysql:host='.dbHost.';dbname='.dbName.';dbcharset='.dbCharset,dbUser,dbPass
        );    
            //cai dat su li ngoai le 
